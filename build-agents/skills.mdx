...
<Steps>
  ...
  <Step title="Create a new skill">
    1. Go to **Build > Agents** and select your agent, then click **Agent Studio** to open the Agent Studio screen
  ...
  <Step title="Attach skills to an agent">
    1. In the Agent Studio, click **+ Add Skill** and select the skills you want to attach
    2. Confirm each attached skill is Active and correctly configured
  </Step>
