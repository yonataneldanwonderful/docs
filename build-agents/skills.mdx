...
To create and manage skills, navigate to the **Agent Studio** screen. You can access Agent Studio by going to **Build > Agents** and selecting an agent from the list.
...
<Steps>
  ...
  <Step title="Create a new skill">
    In Agent Studio:
    1. Open the **Skills tab** in the left panel
    2. Click **+ New Skill**
  ...
  <Step title="Attach skills to an agent">
    In Agent Studio:
    1. Open the **Skills tab** in the left panel
    2. Click **+ Add Skill** and select the skills you want to attach
    3. Confirm each attached skill is Active and correctly configured
  </Step>
